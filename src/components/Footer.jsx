...
const Footer = () => {
  return (
    <footer className="text-gray-800 max-w-8xl bg-gray-100 rounded-t-4xl rounded-r-4xl">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-3">
            <div className="flex items-center space-x-2">
              <span className="font-posterama text-4xl font-bold text-gray-800 tracking-wider">
                XOLVA
              </span>
            </div>
          </div>
          ...
          <div className="lg:col-span-3">
            <div className="flex justify-center lg:justify-end space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-200 hover:bg-blue-200 text-gray-800 rounded-lg flex items-center justify-center transition-colors duration-200"
                aria-label="Facebook"
              >
              ...
              <a
                href="#"
                className="w-10 h-10 bg-gray-200 hover:bg-blue-100 text-gray-800 rounded-lg flex items-center justify-center transition-colors duration-200"
                aria-label="Twitter"
              >
