...
const CTAButtons: React.FC = () => (
  <>
    ...
    <div className="flex flex-col sm:flex-row gap-2">
      ...
      <Link
        href={"/our-services"}
        className="group flex items-center justify-center px-6 py-3 bg-gradient-to-r from-gray-800/40 to-gray-700/40 border border-gray-600/50 rounded-full text-gray-300 hover:text-white hover:border-gray-500/60 transition-all duration-300 backdrop-blur-sm"
      >
